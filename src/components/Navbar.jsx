      ...
      <div className="mx-auto max-w-7xl px-6 py-4">
        <div className="flex items-center justify-between rounded-xl border border-white/10 bg-white/5 backdrop-blur supports-[backdrop-filter]:bg-white/5">
          <div className="flex items-center gap-3 px-4 py-3">
            {/* Use uploaded logo if available at /Syntric_Logo.png */}
            <img
              src="/Syntric_Logo.png"
              alt="Syntric Logo"
            ...
            />
            <div id="logo-fallback" className="h-8 w-8 rounded bg-gradient-to-br from-purple-500 to-emerald-400 sm:hidden" />
